...
class gc_eos_class:
    ...
    def evaluate_der_eos_P(self):
        ...
        self.dPdT = R/(self.Veos-self.b_m) - self.der_a/(self.Veos**2 + self.Veos*self.b_m)
    ...
    def soave_parameters(self):
        ...
        self.b = [R*sp.Tc*0.08664/sp.Pc for sp in self.mixture.list_of_species]

        self.a_c = [R**2*sp.Tc**2*0.42747/
